...
import { addChatthree } from "../Redux/slice";

export default function Azzadchating(props) {
  const chat = useSelector((state) => state.notify.chatstwo);
  ...
  const handleAdd = (event) => {
    ...
    dispatch(addChatthree(chatting));
    setchatting("");
  };
  return (
    <>
